...
const string robot_file = "./resources/satellite.urdf";
...
int main() {
	...
	// VectorXd landing_position = VectorXd::Zero(dof);
	// landing_position=initial_q;

// 	const string control_link_body = "link6";
...
// #endif
	...
	while (runloop) {
		...
		// 	// joint_task->_desired_position = landing_position;
