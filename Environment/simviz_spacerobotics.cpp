...
int main() {
	...
	robot->_q << -0.8, 0, 0, RAD(35), RAD(0), RAD(0), RAD(-22.530476674), RAD(-38.938842011), RAD(-9.5874173775), RAD(86.55788003), RAD(35.068683992), RAD(-32.703571509), RAD(-22.68013325), RAD(-22.451580385), RAD(38.858341441), RAD(9.6591516935), RAD(86.49771946), RAD(-35.222695047), RAD(-32.634014433), RAD(22.559812113);
	//robot->_q(0) = -0.8;
...
void simulation(Sai2Model::Sai2Model* robot, Sai2Model::Sai2Model* object, Simulation::Sai2Simulation* sim)
{
	...
	double time_slowdown_factor = 8.0; // adjust to higher value (i.e. 2) to slow down simulation by this factor relative to real time (for slower machines)
